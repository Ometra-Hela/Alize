 ...
 * @method static array requestNip(string $msisdn, string|null $dida = null)
 ...
 * @method static array requestReversion(\Ometra\HelaAlize\Models\Portability $portability, string|null $reason = null)
